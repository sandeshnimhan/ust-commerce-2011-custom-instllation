 ...
 */
package org.ust.core.suggestion;
...
import org.ust.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/ustcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
