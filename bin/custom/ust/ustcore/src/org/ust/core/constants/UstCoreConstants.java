 ...
 */
package org.ust.core.constants;

/**
 * Global class for all UstCore constants. You can add global constants for your extension into this class.
 */
public final class UstCoreConstants extends GeneratedUstCoreConstants
{
	public static final String EXTENSIONNAME = "ustcore";


	private UstCoreConstants()
	{
		//empty
	}
