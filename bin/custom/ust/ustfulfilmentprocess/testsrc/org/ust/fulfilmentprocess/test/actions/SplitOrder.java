 ...
 */
package org.ust.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(UstFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(UstFulfilmentProcessConstants.PARENT_PROCESS);
