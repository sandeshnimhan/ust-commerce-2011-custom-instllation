...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/uststorefront/electronics/en",
						"https://electronics.local:9002/uststorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/uststorefront/electronics/en",
						"https://electronics.local:9002/uststorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/uststorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/uststorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/uststorefront/electronics/en",
						"https://electronics.local:9002/uststorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/uststorefront",
						"https://electronics.local:9002/uststorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/uststorefront",
						"https://electronics.local:9002/uststorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/uststorefront/electronics/en",
						"https://electronics.local:9002/uststorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
