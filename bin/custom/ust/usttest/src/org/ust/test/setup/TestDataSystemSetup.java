...
import org.ust.test.constants.UstTestConstants;
import org.ust.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = UstTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/usttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/usttest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/usttest/import/cstickets.impex");
			...
			importImpexFile(context, "/usttest/import/csquotes.impex");
		}
	}
}
