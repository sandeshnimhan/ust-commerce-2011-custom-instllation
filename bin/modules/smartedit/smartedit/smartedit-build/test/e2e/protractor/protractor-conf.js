...
const chromeDriverPattern = './node_modules/protractor/**/chromedriver*[^zip]';
...
const getChromeDriver = () => {
    const chromeDriver = fg.sync(chromeDriverPattern);
    return chromeDriver.length ? chromeDriver[0] : null;
};

let chromeDriver = getChromeDriver();
if (!chromeDriver) {
    throw new Error(
    ...
    console.log('Chrome driver found in:', chromeDriver);
}

exports.config = {
    allScriptsTimeout: ASYNC_WAIT,

    chromeDriver: path.resolve(chromeDriver),
