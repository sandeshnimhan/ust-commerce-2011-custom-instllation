...
module.exports = function() {
    ...
    return {
        ...
        config: function(data, conf) {
            ...
            conf.generateComopodocSmarteditCommonsTsConfig.data = lodash.cloneDeep(
                tsConfigTemplates.baseConfig
            );
            ...
            conf.generateComopodocSmarteditTsConfig.data = lodash.cloneDeep(
                tsConfigTemplates.baseConfig
            );
            ...
            conf.generateComopodocSmarteditContainerTsConfig.data = lodash.cloneDeep(
                tsConfigTemplates.baseConfig
            );
