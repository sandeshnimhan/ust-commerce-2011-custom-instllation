...
export declare const USER_GLOBAL_PERMISSIONS_RESOURCE_URI = "/permissionswebservices/v1/permissions/principals/:user/global";
 ...
 */
export declare const CATALOG_VERSION_PERMISSIONS_RESOURCE_URI_CONSTANT = "/permissionswebservices/v1/permissions/principals/:principal/catalogs";
