...
module.exports = (function() {
    ...
    paths.webpack = {
        libSmarteditCommons: `${
            bundlePaths.webpackConfigPath
        }/webpack.lib.smarteditcommons.config.js`,
        prodSmarteditCommons: `${
            bundlePaths.webpackConfigPath
        }/webpack.prod.smarteditCommons.config.js`,
        devSmarteditCommons: `${
            bundlePaths.webpackConfigPath
        }/webpack.dev.smarteditCommons.config.js`,
        karmaSmarteditcommons: `${
            bundlePaths.webpackConfigPath
        }/webpack.karma.smarteditcommons.config.js`,
    ...
    paths.tsConfigInclude.compodocSmarteditCommons = ['../../compodocs/common/**/*.ts'];

    paths.tsConfigInclude.compodocSmartedit = ['../../compodocs/smartedit/**/*.ts'];
