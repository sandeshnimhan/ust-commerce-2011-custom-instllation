 ...
 */
export declare const createRootMapper: (fieldsMap: import("@smart/utils").TypedMap<GenericEditorField[]>, component: Payload, languages: ILanguage[], tabs: GenericEditorTab[]) => RootSchemaDataMapper;
